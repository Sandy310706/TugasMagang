...
@section('keranjang')
    ...
    <div class="svg-container">
        <svg class="svg-kuning" xmlns="http://www.w3.org/2000/svg" width="241" height="307" viewBox="0 0 241 307"
            fill="none">
            <path
                d="M237.798 73.7377C243.288 214.012 35.4739 363.38 -178.18 284.823C-319.791 243.915 -115.129 -15.9893 -340.571 -105.373C-459.148 -182.289 -428.244 -284.674 -323.268 -337.795C-234.046 -404.876 279.609 -184.559 237.798 73.7377Z"
                fill="#96C291" />
        </svg>
        <svg class="svg-hijau" width="165" height="176" viewBox="0 0 165 176" fill="none"
    ...
    <div class="svg-container-2">
        <svg class="hijau-kanan" width="250" height="200" viewBox="0 0 352 390" fill="none"
            xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_1859_1681" x="0" y="0" width="507" height="507" filterUnits="userSpaceOnUse"
        ...
        <svg class="kuning-kiri" width="197" height="206" viewBox="0 0 197 206" fill="none"
            xmlns="http://www.w3.org/2000/svg">
