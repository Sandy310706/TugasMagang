        ...
        <div class="container" style="display: flex; justify-content: center; align-items: center;">
            @error('feedback')
                <div class="alert" id="alert">
                    <span class="tutup" id="trigger"><i class="fa-solid fa-xmark"></i></span>
                    <i class="fa-solid fa-triangle-exclamation"></i> {{ $message }}
                </div>
            @enderror
            @if(session('success'))
            <div class="alert-berhasil" id="alert">
                <span class="tutup" id="trigger"><i class="fa-solid fa-xmark"></i></span>
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col">
                            <div class="form-group form-group-textarea mb-md-0">
                                <textarea class="form-control" rows="6" id="feedback" name="feedback" placeholder="Feedback*"></textarea>
                            </div>
                        </div>
                    </div>
