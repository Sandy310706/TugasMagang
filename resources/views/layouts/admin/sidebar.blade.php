<div class="w-1/5 lgTablet:w-[30%] h-screen left-0 top-0 lgTablet:top-20 bg-slate-800 text-slate-200 shadow-lg object-cover shadow-black fixed z-50 lgTablet:hidden" id="Sidebar">
    <div class="h-1/5 flex">
        <img class="mx-auto pt-6 text-4xl font-sans scale-150 lgTablet:scale-100" src="{{ asset('img/Frederick.png') }}"></img>
    </div>
