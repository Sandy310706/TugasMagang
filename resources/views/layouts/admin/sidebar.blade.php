<div class="w-[20%] lgTablet:w-[40%] h-screen fixed lgMobile:hidden mobile:hidden lgTablet:hidden left-0 top-0 lgTablet:top-20 bg-slate-800 text-slate-200 shadow-lg object-cover shadow-black z-50" id="Sidebar">
    ...
    <div class="container w-3/4 font-outfit text-md group mt-1">
        <a href="#" class="block py-2 pl-3 text-slate-400 hover:ring-1 hover:ring-white group-hover:text-white rounded-r-xl hover:bg-sky-400 transition duration-200 hover:ease-in"><span><i class="bi bi-bar-chart-fill group-hover:text-white"></i> Kelola Keuangan</span></a>
    </div>
    <div class="container w-3/4 font-outfit text-md group mt-1">
    ...
    <div class="container w-3/4 font-outfit text-md group mt-1">
        <a href="#" class="block py-2 pl-3 text-slate-400 hover:ring-1 hover:ring-white group-hover:text-white rounded-r-xl hover:bg-sky-400 transition duration-200 hover:ease-in"><span> Kelola Pesanan</span></a>
    </div>
    <div class="container w-3/4 font-outfit text-md group mt-1">
