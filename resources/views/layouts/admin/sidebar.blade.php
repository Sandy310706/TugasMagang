<div class="w-[20%] lgTablet:w-[40%] h-screen fixed lgMobile:hidden mobile:hidden lgTablet:hidden left-0 top-0 lgTablet:top-20 bg-slate-800 text-slate-200 shadow-lg object-cover shadow-black z-50" id="Sidebar">
    <div class="h-1/5 flex">
        <img class="mx-auto font-sans scale-150 lgTablet:scale-100" src="{{ asset('img/Icon.png') }}"></img>
    </div>
    <hr class="w-[80%] mb-2 border-b-2 border-slate-600">
    <div class="container w-3/4 font-outfit text-md group">
    ...
    <div class="container w-3/4 font-outfit text-md group mt-1">
        <a href="{{ route('Admin.Pesanan') }}" class="block py-2 pl-3 text-slate-400 hover:ring-1 hover:ring-white group-hover:text-white rounded-r-xl hover:bg-sky-400 transition duration-200 hover:ease-in"><span><i class="fa-solid fa-comment-dots"></i> Kelola Pesanan</span></a>
    </div>
    <div class="container w-3/4 font-outfit text-md group mt-1">
