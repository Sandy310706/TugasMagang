<div class="w-1/5 h-screen left-0 top-0 bg-slate-800 text-slate-200 shadow-lg shadow-black fixed">
    ...
    <div class="oontainer w-3/4 font-outfit text-md group mt-4">
        <div class="py-2 pl-3 text-slate-400 group-hover:text-white rounded-r-xl hover:bg-sky-400 transition duration-200 hover:ease-in-out"><a href="/"><span><i class="bi bi-house-door-fill group-hover:text-white"></i> Kelola Akun</span></a></div>
    </div>
</div>
