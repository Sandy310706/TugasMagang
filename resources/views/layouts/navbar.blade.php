<div class="h-20 box-border">
    <div class="bg-slate-900 h-20 flex fixed w-4/5 text-white" style="z-index: 2">
        <h1 class="w-1/2 font-medium text-3xl my-auto ml-4">@yield('headerNav')</h1>
        <div class="w-1/2 relative" style="z-index: 2">
            <button class="absolute right-20 top-7  hover:text-slate-300 " id="dropdownTrigger">Hallo, {{ auth()->user()->nama }} <i class="fa-solid fa-play scale-75" style="transition: transform 1s;" id="dropdownIcon"></i></button>
            <div class="absolute right-4 top-14 mt-2 w-48 bg-white border rounded-lg shadow-lg duration-1000 hidden" id="dropdownMenu">
                <ul>
