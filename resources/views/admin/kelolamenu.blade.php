...
<div class="w-full relative">
    <div class="flex mb-2 h-auto tablet:pl-4">
        <div class="w-1/2">
            <button id="showModal" onclick="OpenModal()" class="mb-2 p-2 w-44 bg-gradient-to-r from-blue-400 to-blue-700 text-white rounded-md font-outfit  hover:from-blue-500 hover:to-blue-800">Tambah Menu</button>
        </div>
    </div>
    <div class="w-full">
                    ...
                    <tr class="group border-b even:bg-zinc-300 odd:bg-neutral-200 border-gray-400">
                        ...
                        <td class="p-2 group-hover:bg-neutral-400">
                            ...
                            <form action="{{ route('Menu.Delete', $menu->id) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" onclick="confirm()" class="text-pink-600"><i class="fa-solid fa-trash mobile:inline"></i><span class="mobile:hidden"> Hapus</span></button>
                            </form>
                        </td>
                    </tr>
