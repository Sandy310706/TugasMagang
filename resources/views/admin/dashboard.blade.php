...
@section('dashboard')
    <div class="w-full h-28 mt-3 flex justify-evenly">
        <div class="relative w-[212px] h-32 bg-green-700 text-white rounded-md hover:bg-green-800">
            <div class="p-1">
        ...
        <div class="relative w-[212px] h-32 bg-emerald-400 text-white rounded-md hover:bg-emerald-500">
            <div class="p-1">
        ...
        <div class="relative w-[212px] h-32 bg-amber-600 text-white rounded-md hover:bg-amber-700">
            <div class="p-1">
        ...
        <div class="relative w-[212px] h-32 bg-red-800 text-white rounded-md hover:bg-red-900" style="z-index: 1">
            <div class="p-1">
